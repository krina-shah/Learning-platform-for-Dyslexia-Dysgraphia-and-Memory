...
<form method="POST" action="{{ url_for('pcage4')}}">
    <div  class="col-lg-12  col-md-12  col-sm-12  col-xs-12" data-aos="fade-down">
    
      <h1>Passage Comprehension</h1>
      <br>
      <h2 class="text-justify">
        The sun and the rain in fickle weather<br>
        Were playing hide and seek together;<br>
        And each in turn would try to chase<br>
        The other from his hiding place<br>
        Atlast they meet to say, 'Good-bye'<br>
        And Lo! A rainbow spanned the sky<br>
</h2>
<br>
<h3>Answer the following questions.</h3>
<h2>1) Who were playing hide and seek? </h2><br>
<h4><input type="text" id="ans1" class="shape"></h4>
<br>
<h2>2) What kind of weather is mention above?  </h2><br>
<h4><input type="text" id="ans2" class="shape"></h4>
<br>
<h2>3) What did the sun and the rain said to eachother when they meat ?   </h2><br>
<h4><input type="text" id="ans3" class="shape"></h4>
<br>
<h2>4) What spanned the sky ? </h2><br>
...
<input type="submit" class="btn btn-primary btn-lg"   onclick="getans1()" name ="q4age4">
...
<script type="text/javascript">
  function getans1() {
    ...
    if (ans1=="sun and rain" || ans1=="Sun and rain" || ans1=="sun and rain were playing hide and seek" || ans1=="Sun and rain were playing hide and seek" || ans1=="the sun and the rain were playing hide and seek" || ans1=="The sun and the rain were playing hide and seek") {
      var ques1="correct";
    }
    else{
      var ques1="wrong";
...
<script type="text/javascript">
  function getans2() {
    ...
    if (ans2=="fickle" || ans2=="Fickle" || ans2=="fickle weather is mention above" || ans2=="Fickle weather is mention above") {
      var ques2="correct";
    }
    else{
      var ques2="wrong";
...
<script type="text/javascript">
  function getans3() {
    ...
    if (ans3=="Good-bye" || ans3=="goodbye" || ans3=="the sun and the rain said goodbye to eachother when they meat" ans3=="the sun and the rain said Good-bye to eachother when they meat") {
      var ques3="correct";
    }
    else{
      var ques3="wrong";
...
<script type="text/javascript">
  function getans4() {
    ...
    if (ans4=="rainbow" || ans4=="Rainbow" || ans4=="rainbow spanned the sky" ||ans4=="Rainbow spanned the sky" || ans4=="the rainbow") {
      var ques4="correct";
    }
    else{
      var ques4="wrong";
