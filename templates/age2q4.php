...
<form method="POST" action="{{ url_for('pcage2')}}">
    <div  class="col-lg-12  col-md-12  col-sm-12  col-xs-12" data-aos="fade-down">
    
      <h1>Passage Comprehension</h1>
      <br>
      <h2 class="text-justify">In a thick jungle there lived a big lion. He was ver strong. He was the king of the jungle. All the other animals were afraid of him. They would run and hide , when they heard the lion roar.
</h2>
<br>
<h3>Answer the following questions.</h3>
<h2>1) Where did the lion live ? </h2><br>
<h4><input type="text" id="ans1" class="shape"></h4>
<br>
<h2>2) Was the lion strong or weak?  </h2><br>
<h4><input type="text" id="ans2" class="shape"></h4>
<br>
<h2>3) Which animal was the king of the jungle ?   </h2><br>
<h4><input type="text" id="ans3" class="shape"></h4>
<br>
<h2>4) What did the other animals do when the lion roared ? </h2><br>
...
<input type="submit" class="btn btn-primary btn-lg"   onclick="getans1()" name ="q4age2">
...
<script type="text/javascript">
  function getans1() {
    ...
    if (ans1=="jungle" || ans1=="Jungle" || ans1=="In a thick jungle" || ans1=="in a thick jungle" || ans1=="thick jungle" || ans1=="Thick jungle") {
      var ques1="correct";
    }
    else{
      var ques1="wrong";
...
<script type="text/javascript">
  function getans2() {
    ...
    if (ans2=="strong" || ans2=="Strong" || ans2=="The lion was strong" || ans2=="the lion was strong") {
      var ques2="correct";
    }
    else{
      var ques2="wrong";
...
<script type="text/javascript">
  function getans3() {
    ...
    if (ans3=="lion" || ans3=="Lion" || ans3=="The lion" ans3=="the lion") {
      var ques3="correct";
    }
    else{
      var ques3="wrong";
...
<script type="text/javascript">
  function getans4() {
    ...
    if (ans4=="They would run and hide" || ans4=="they would run and hide" || ans4=="run and hide" ||ans4=="Run and hide" || ans4=="Run and Hide") {
      var ques4="correct";
    }
    else{
      var ques4="wrong";
