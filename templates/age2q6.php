...
<form method="POST" action="{{ url_for('srage2')}}">
    <div  class="col-lg-12  col-md-12  col-sm-12  col-xs-12" data-aos="fade-down">
      ...
      <h2 id="myDIV">1) The peacoack is a beautiful bird.</h2> 
      ...
      <h2 id="myDIV">2) There are many books in the library.</h2> 
...
<input type="submit" class="btn btn-primary btn-lg" id="btn_submit" onclick="getans1()" name="q6age2">
    </div>
    </form>
    </section>
<br><br>
...
<script type="text/javascript">
  function getans1() {
    ...
    if (ans1=="the peacoack is a beautiful bird") {
      var ques1="correct";
    }
    else{
      var ques1="wrong";
...
<script type="text/javascript">
  function getans2() {
    ...
    if (ans2=="there are many books in the library") {
      var ques2="correct";
    }
    else{
      var ques2="wrong";
