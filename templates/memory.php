...
{% endif %}</p></strong></p></strong></p>
  ...
  <div class="container-fluid">
    ...
    <form method="POST" id="demoForm" name="myform" action="{{ url_for('memoryform')}}">
<h3>Select the answer to each question, and click on the "Submit" button to submit the information.</h3>

<P>Q1) Does the child Requires frequent reminders? <BR>
...
<P>Q2)Does the child Forgets the content of instruction?<BR>
...
<P>Q3)Is the child able to find the exact word such as confusing words that sound alike? (cognitive becomes conjunctive)<BR>
...
<P>Q4)Is the child able to recall past events ?<BR>
...
<P>Q5) Is the child able to remember names but forgets the faces of relatives and classmates ?<BR>
...
<P>Q6)Difficulty remembering information from listening, e.g. taking messages in a phone conversation.<BR>
...
<P>Q7)Difficulty remembering information from reading, eg. simple facts, names,dates,times,places, etc <BR>
...
<button class="btn btn-primary" type="submit"  id="btn" value="Submit" name="memorysubmit" onclick="myFunction()">Submit</button>
<br>
</form>
