...
<form method="POST" action="{{ url_for('lwage2')}}">
...
<h2 id="myDIV">3) Believe</h2>
      ...
      <button type="button" class="btn btn-primary btn-lg"  id="start-btn2"  onclick="myFunction32()">Start</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-primary btn-lg"  id="stop-btn2" >Stop</button>
         ...
         <h2 id="myDIV">4) Zelieve</h2>
      <input type="hidden" rows="10"  id="textbox3" >
      <br><br>
      <button type="button" class="btn btn-primary btn-lg"  id="start-btn3"  onclick="myFunction33()">Start</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-primary btn-lg"  id="stop-btn3" >Stop</button>
<br><br>
...
<input type="submit" class="btn btn-primary btn-lg"   onclick="getans1()" name ="q5age2">
...
<script type="text/javascript">
  function getans4() {
    var ans4=document.getElementById("textbox3").value;
    if (ans4=="zelieve") {
      var ques4="correct";
    }
    else{
