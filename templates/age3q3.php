...
<form method="POST" id="demoform" name="myform" action="{{ url_for('pvage3')}}">
    <div  class="col-lg-12  col-md-12  col-sm-12  col-xs-12" data-aos="fade-down">
      ...
      <img class="shape" src="img/hour.png">
      </div></center>
      <h2><input type="radio" name="hour" value="hour" class="size"> HOUR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="our" value="our" class="size"> OUR</h2>
  <br>
   
    <h3>2) Select the correct option.</h3>
   <center><div class="shape">
     
      <img class="shape" src="img/tail.jpg">
      </div></center>
      <h2><input type="radio" name="TALE" value="TALE" class="size"> TALE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="TALE" value="TAIL" class="size"> TAIL</h2>
<br>
<h3>3) Select the correct option.</h3>
<center><div class="shape1">
      <img class="shape1" src="img/eye.jpg">
      </div></center>
      <h2><input type="radio" name="EYE" value="EYE" class="size"> EYE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="EYE" value="I" class="size"> I</h2>

<br>
<h3>4) Select the correct option.</h3>
<center><div class="shape">
      <img class="shape" src="img/way.jpg">
      </div></center>
      <h2><input type="radio" name="WAY" value="WAY" class="size"> WAY&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="WAY" value="WEIGH" class="size"> WEIGH</h2>
...
<input type="hidden" name="result4" id="data4">
 ...
 <input type="submit" class="btn btn-primary btn-lg"   onclick="getans1()" name ="q3age3">
...
{% block content %}
  ...
  function getans1() {
    //alert("hello");
    var ans1=($("input[name=hour]:checked").val());
    if(ans1=="hour"){
  var ques1="correct";
...
<script type="text/javascript">
  function getans2() {
    var ans2=($("input[name=TALE]:checked").val());
    if (ans2=="TAIL") {
      var ques2="correct";
    }
    else{
...
<script type="text/javascript">
  function getans3() {
    var ans3=($("input[name=EYE]:checked").val());
    if (ans3=="EYE") {
      var ques3="correct";
    }
    else{
...
<script type="text/javascript">
  function getans4() {
    var ans4=($("input[name=WAY]:checked").val());
    if (ans4=="WAY") {
      var ques4="correct";
    }
    else{
