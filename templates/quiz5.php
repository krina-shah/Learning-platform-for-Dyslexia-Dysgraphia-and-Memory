...
<form method="POST" action="{{ url_for('lwage1')}}">
...
<input type="submit" class="btn btn-primary btn-lg"   onclick="getans1()" name ="q5age1">
...
<script type="text/javascript">
  function getans3() {
    ...
    if (ans3=="crank"||ans3=="krunk" || ans3=="crunk") {
      var ques3="correct";
    }
    else{
      var ques3="wrong";
