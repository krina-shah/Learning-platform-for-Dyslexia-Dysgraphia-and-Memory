...
<form method="POST" id="demoform" name="myform" action="{{ url_for('pvage4')}}">
    <div  class="col-lg-12  col-md-12  col-sm-12  col-xs-12" data-aos="fade-down">
      ...
      <img class="shape" src="img/Sleepy.png">
      </div></center>
      <h2><input type="radio" name="Sleepy" value="Sleepy" class="size"> Sleepy&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Sleepy" value="Surprise" class="size"> Surprise</h2>
  <br>
   
    <h3>2) Select the correct option.</h3>
   <center><div class="shape">
     
      <img class="shape" src="img/Fear.png">
      </div></center>
      <h2><input type="radio" name="Fear" value="Fear" class="size"> Fear&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Fear" value="Joy" class="size"> Joy</h2>
<br>
<h3>3) Select the correct option.</h3>
<center><div class="shape1">
      <img class="shape1" src="img/Interesting.png">
      </div></center>
      <h2><input type="radio" name="Interesting" value="Scary" class="size"> Bull&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Interesting" value="Interesting" class="size"> Interesting</h2>

<br>
<h3>4) Select the correct option.</h3>
<center><div class="shape">
      <img class="shape" src="img/Excitement.png">
      </div></center>
      <h2><input type="radio" name="Excitement0" value="Disgust" class="size"> Disgust&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Excitement" value="Excitement" class="size"> Excitement</h2>
...
<input type="hidden" name="result4" id="data4">
 ...
 <input type="submit" class="btn btn-primary btn-lg"   onclick="getans1()" name ="q3age4">
...
{% block content %}
  ...
  function getans1() {
    //alert("hello");
    var ans1=($("input[name=Sleepy]:checked").val());
    if(ans1=="Sleepy"){
  var ques1="correct";
...
<script type="text/javascript">
  function getans2() {
    var ans2=($("input[name=Fear]:checked").val());
    if (ans2=="Fear") {
      var ques2="correct";
    }
    else{
...
<script type="text/javascript">
  function getans3() {
    var ans3=($("input[name=Interesting]:checked").val());
    if (ans3=="Interesting") {
      var ques3="correct";
    }
    else{
...
<script type="text/javascript">
  function getans4() {
    var ans4=($("input[name=Excitement]:checked").val());
    if (ans4=="Excitement") {
      var ques4="correct";
    }
    else{
