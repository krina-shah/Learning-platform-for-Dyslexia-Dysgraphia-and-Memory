...
<form method="POST" action="{{ url_for('srage1')}}">
    <div  class="col-lg-12  col-md-12  col-sm-12  col-xs-12" data-aos="fade-down">
      ...
      <h2 id="myDIV">1) My bird can sing</h2> 
      ...
      <h2 id="myDIV">2) My mother has three flowers, they are red,blue and yellow</h2> 
...
<input type="submit" class="btn btn-primary btn-lg" id="btn_submit" onclick="getans1()" name="q6age1">
    </div>
    </form>
    </section>
<br><br>
...
<script type="text/javascript">
  function getans2() {
    ...
    if (ans2=="my mother has three flowers they are red blue and yellow") {
      var ques2="correct";
    }
    else{
      var ques2="wrong";
