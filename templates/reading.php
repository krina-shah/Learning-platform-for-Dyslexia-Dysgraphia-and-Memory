...
{% endif %}</p></strong></p>
  ...
  <div class="container-fluid">
    ...
    <form method="POST" id="demoForm" name="myform" action="{{ url_for('readingform')}}">
<h3>Select the answer to each question, and click on the "Submit" button to submit the information.</h3>

<P>Q1) Is the child able to cope up with reading according to his grade level ?<BR>
...
<P>Q2)  Is the child able to read common printed words ?<BR>
...
<P>Q3) Is the child able to pronounce the words correctly ?<BR>
...
<P>Q4)Is the child able to understand what he/she reads ?<BR>
...
<P>Q5) Does the child have difficulty staying on the line while reading?<BR>
...
<P>Q6)Is the child able to read when the new paragraph is made ?<BR>
...
<P>Q7) Rate the reading of the child.<BR>
...
<button class="btn btn-primary" type="submit"  id="btn" value="Submit" name="readingsubmit" onclick="myFunction()">Submit</button>
<br>
</form>
