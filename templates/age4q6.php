...
<form method="POST" action="{{ url_for('srage4')}}">
    <div  class="col-lg-12  col-md-12  col-sm-12  col-xs-12" data-aos="fade-down">
    
      <h1>Sentence Reading</h1>
      <br>
      <h4>Click On start and Read the sentence loudly</h4>
      <h2 id="myDIV">1)  He just stood there nodding his head. </h2> 
      
      <input type="hidden" rows="10"  id="textbox" >

      <br><br>
      <button type="button" class="btn btn-primary btn-lg"  id="start-btn"  onclick="myFunc3()">Start</button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-primary btn-lg"  id="stop-btn" >Stop</button>


      <h2 id="myDIV">2) The people watching it were speechless.</h2> 
      
      <input type="hidden" rows="10"  id="textbox1" >

      <br><br>
      <button type="button" class="btn btn-primary btn-lg"  id="start-btn1"  onclick="myFunction32()">Start</button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-primary btn-lg"  id="stop-btn1" >Stop</button>
         <!--<button type="button" class="btn btn-primary btn-lg" id="Next" onclick="myFunction()">Next</button>-->
<br><br>
<input type="hidden" name="result1" id="data1">
<input type="hidden" name="result2" id="data2">
<input type="submit" class="btn btn-primary btn-lg" id="btn_submit" onclick="getans1()" name="q6age4">
    </div>
    </form>
    </section>
<br><br>
...
<!--<script type="text/javascript">
  ...
  if (x.innerHTML == "My bird can sing") {
    x.innerHTML = "My mom has three flowers, they are red,blue and yellow";
  }
  else if (x.innerHTML == "My mom has three flowers, they are red,blue and yellow") {
    x.innerHTML = "Well-done Click on Submit ";
...
<script type="text/javascript">
  function getans1() {
    ...
    if (ans1=="he just stood there nodding his head") {
      var ques1="correct";
    }
    else{
      var ques1="wrong";
...
<script type="text/javascript">
  function getans2() {
    ...
    if (ans2=="the people watching it were speechless") {
      var ques2="correct";
    }
    else{
      var ques2="wrong";
