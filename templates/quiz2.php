...
<img  id="logo" src="{{ url_for('static', filename='img/logo.png') }}" >
  ...
  {{ session['username'] }}
{% endif %}</p></strong></p></strong></p></strong></p></strong></p>
...
<form method="POST" id="demoform" name="myform" action="{{ url_for('sosage1')}}">
    <div  class="col-lg-12  col-md-12  col-sm-12  col-xs-12" data-aos="fade-down">
    
      <h1>Sound Of Spellings </h1>
      <br>
      <pre><h2 >1) My <input type="text" class="shape" id="ans11"> is 13 years 
old. He likes to watch  <input type="text" class="shape" id="ans12"></h2>
<input type="button" class="btn btn-info btn-lg glyphicon glyphicon-volume-up" onclick="myFunction1()" value="Hear it"></pre> 
       
  <br>
   <pre> <h2 >2) I open my window and 
    <input type="text" class="shape" id="ans21"> the  <input type="text" class="shape" id="ans22"></h2>
   <input type="button" class="btn btn-info btn-lg glyphicon glyphicon-volume-up" onclick="myFunction2()" value="Hear it"></pre>
   
  <br>
   <pre><h2 >3) She has <input type="text" class="shape" id="ans31"> 
chocolates  <input type="text" class="shape" id="ans32">  me</h2>
...
<!-- <button class="btn btn-info btn-lg" onclick="getans1()">Submit</button>-->
 <input type="submit" class="btn btn-primary btn-lg"   onclick="getans1()" name ="q2age1">
...
<script type="text/javascript">
  function myFunction1(){
    var inputmsg="My son is 13 years old,He likes to watch sunrise";
...
<script type="text/javascript">
  function myFunction2(){
    var inputmsg="I open my window and see the sea";
    var msg = new SpeechSynthesisUtterance(inputmsg);
    window.speechSynthesis.speak(msg);
  }
...
<script type="text/javascript">
  function myFunction3(){
    var inputmsg="She has four chocolates for me";
    var msg = new SpeechSynthesisUtterance(inputmsg);
    window.speechSynthesis.speak(msg);
  }
...
if(ans11!="son" && ans12!="sunrise"){
  var ques1="wrong";
  
}
else if(ans11!="son" && ans12=="sunrise"){
  var ques1="wrong";
...
if(ans21!="see" && ans22!="sea"){
  var ques2="wrong";
  
}
else if(ans21!="see" && ans22=="sea"){
  var ques2="wrong";
...
if(ans31!="four" && ans32!="for"){
  var ques3="wrong";
  
}
else if(ans31!="four" && ans32=="for"){
  var ques3="wrong";
