...
{%for message in get_flashed_messages()%}
 ...
 {% endfor %}
    ...
    <!-- <legend><img src="img/icon.png" width="90" height="90"></legend> -->
   


      <form method="POST" name="registerform" action="{{ url_for('registerform')}}">
        <h2>Register Here</h2><br>
        <?php include('errors.php'); ?>
      <!-- <center><h3>Userame : <input type="text" name="username"  class="inputtype"></h3> -->
               <input type="text" name="username" class="form-control form-control-lg" placeholder="Username" ><br>
              <input type="email" name="email"   class="form-control form-control-lg" placeholder="Email" ><br>
              
               <input type="number" name="std"   class="form-control form-control-lg" placeholder="Standard(1/2/3/4)" ><br>
              <input type="password" name="password_1"  class="form-control form-control-lg" placeholder="Password" ><br>
              <input type="password" name="password_2"  class="form-control form-control-lg" placeholder="Confirm Password"><br>
           <button  type="submit" class="btn btn-primary btn-primary1" name="reg_user">Register</button>

          <a href="index.php"><button  type="button" class="btn btn-primary btn-primary1">BACK</button></a>
