...
<!-- <button class="btn btn-info btn-lg" onclick="getans1()">Submit</button>-->
 <input type="submit" class="btn btn-primary btn-lg"   onclick="getans1()" name ="q2age2">
...
<script type="text/javascript">
  function myFunction1(){
    var inputmsg="I write with my right hand";
...
<script type="text/javascript">
  function myFunction3(){
    var inputmsg="Teacher reads the fairytale to her students";
    var msg = new SpeechSynthesisUtterance(inputmsg);
    window.speechSynthesis.speak(msg);
  }
...
<script type="text/javascript">
  function getans1(){
  var ans11=document.getElementById('ans1').value;
    var ans12=document.getElementById('ans2').value;
       
    //alert("height");
    
if (ans11=="write" && ans12=="right") {
  var ques1="correct";
}
else if (ans11!="write" && ans12=="right") {
  var ques1="wrong";
}
else if(ans11=="write" && ans12!="right")
{
