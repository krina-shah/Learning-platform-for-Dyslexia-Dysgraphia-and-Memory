...
<form method="POST" id="demoform" name="myform" action="{{ url_for('sosage4')}}">
    <div  class="col-lg-12  col-md-12  col-sm-12  col-xs-12" data-aos="fade-down">
    
      <h1>Spelling Of Sounds</h1>
      <br>
      <pre><h2 >1)She boarded the <input type="text" class="shape" id="ans11"> <br>wearing a<input type="text" class="shape" id="ans12">black dress</h2>
<input type="button" class="btn btn-info btn-lg glyphicon glyphicon-volume-up" onclick="myFunction1()" value="Hear it"></pre> 
       
  <br>
   <pre> <h2 >2) The guitarist smashed up <br>his<input type="text" class="shape" id="ans21"> on-stage at<br> the end of the concert, his<br> fan <input type="text" class="shape" id="ans22"> cheered him</h2>
   <input type="button" class="btn btn-info btn-lg glyphicon glyphicon-volume-up" onclick="myFunction2()" value="Hear it"></pre>
   
  <br>
   <pre><h2 >3)  <input type="text" class="shape" id="ans31"> was studying <br>about <input type="text" class="shape" id="ans32"></h2>
...
<!-- <button class="btn btn-info btn-lg" onclick="getans1()">Submit</button>-->
 <input type="submit" class="btn btn-primary btn-lg"   onclick="getans1()" name ="q2age4">
...
<script type="text/javascript">
  function myFunction1(){
    var inputmsg="She boarded the plane, wearing a plain black dress";
...
<script type="text/javascript">
  function myFunction2(){
    var inputmsg="The guitarist smashed up his bass on-stage at the end of the concert, his fan base cheered him";
    var msg = new SpeechSynthesisUtterance(inputmsg);
    window.speechSynthesis.speak(msg);
  }
...
<script type="text/javascript">
  function myFunction3(){
    var inputmsg="Jean was studying about genes";
    var msg = new SpeechSynthesisUtterance(inputmsg);
    window.speechSynthesis.speak(msg);
  }
...
if(ans11!="plane" && ans12!="plain"){
  var ques1="wrong";
  
}
else if(ans11!="plane" && ans12=="plain"){
  var ques1="wrong";
...
if(ans21!="bass" && ans22!="base"){
  var ques2="wrong";
  
}
else if(ans21!="bass" && ans22=="base"){
  var ques2="wrong";
...
if(ans31!="jean" && ans32!="gene"){
  var ques3="wrong";
  
}
else if(ans31!="jean" && ans32=="gene"){
  var ques3="wrong";
