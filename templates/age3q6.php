...
<form method="POST" action="{{ url_for('srage3')}}">
    <div  class="col-lg-12  col-md-12  col-sm-12  col-xs-12" data-aos="fade-down">
      ...
      <h2 id="myDIV">1)The pizza smells delicious.</h2> 
      ...
      <h2 id="myDIV">2)The frog jumped and landed in the pond.</h2> 
...
<input type="submit" class="btn btn-primary btn-lg" id="btn_submit" onclick="getans1()" name="q6age3">
    </div>
    </form>
    </section>
<br><br>
...
<script type="text/javascript">
  function getans1() {
    ...
    if (ans1=="the pizza smells delicious") {
      var ques1="correct";
    }
    else{
      var ques1="wrong";
...
<script type="text/javascript">
  function getans2() {
    ...
    if (ans2=="the frog jumped and landed in the pond") {
      var ques2="correct";
    }
    else{
      var ques2="wrong";
